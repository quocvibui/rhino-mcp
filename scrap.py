...
# Create box using corner-to-corner method
corner1 = rs.CreatePoint({x}, {y}, {z})
corner2 = rs.CreatePoint({x + width}, {y + depth}, {z + height})

# Create box
box_id = rs.AddBox([corner1, corner2])
...
'''
        ...
        try:
            ...
            # Execute the script
            cmd = [rhino_path, "-runscript", f"_-RunPythonScript {script_path}"]
